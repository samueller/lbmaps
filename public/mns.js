const width = (height = 575),
  ...
  initialModel =
    boundsOf => bounds => obsData => hoverPopup => px => pycx => pycxp => {
      const pxp = 1 - px,
        pxy = px * pycx,
        pxyp = px * (1 - pycx),
        pxpy = pxp * pycxp,
    ...
    if (model.obsData) {
      ...
      svg
        ...
        .attr(
          'x1',
          scaleX(
            (possibilityWindow[5][0] * 7) / 8 +
              (possibilityWindow[6][0] * 1) / 8
          )
        )
        .attr('y1', scaleY(possibilityWindow[6][1] - 0.075))
        .attr(
          'x2',
          scaleX(
            (possibilityWindow[5][0] * 3) / 4 + possibilityWindow[6][0] / 4
          )
        )
        .attr('y2', scaleY(possibilityWindow[6][1]))
        .transition()
      ...
      svg
        ...
        .attr('opacity', 1)
      svg
        .select('line.mono-label')
        .attr(
          'x1',
          scaleX(
            (possibilityWindow[5][0] * 0) / 32 +
              (possibilityWindow[6][0] * 33) / 32 -
              0.0 //1
          )
        )
        ...
        .attr(
          ...
          scaleX(
            (possibilityWindow[5][0] * 0) / 32 +
              (possibilityWindow[6][0] * 32) / 32 -
              0.0 //1
          )
        )
        .attr('y2', scaleY(possibilityWindow[6][1] - 0.004))
        .transition()
        .duration(1000)
        .attr('opacity', 1)
      svg
        .select('text.mono-label')
        .attr(
          'transform',
          `translate(${[
            scaleX(
              (possibilityWindow[5][0] * 1) / 8 +
                (possibilityWindow[6][0] * 7) / 8
            ),
            scaleY(possibilityWindow[6][1] - 0.05),
          ]})`
        )
        .transition()
        .duration(1000)
